---
layout: post
title: java.lang.management 包概述
category: Java
tags: [java.lang.management]
keywords: java.lang.management
excerpt: java.lang.management 提供管理接口，用于监视和管理 Java 虚拟机以及 Java 虚拟机在其上运行的操作系统。它同时允许从本地和远程对正在运行的 Java 虚拟机进行监视和管理。
---
...
MemoryPoolMXBean：Java虚拟机中的的内存池。
...
public class ManagementDemo {
    ...
    public static void visitMBean() {
        ...
        try { // Assuming the RuntimeMXBean has been registered in mbs ObjectName
            oname = new ObjectName(ManagementFactory.RUNTIME_MXBEAN_NAME);
...
[https://my.oschina.net/u/2416019/blog/493541](https://my.oschina.net/u/2416019/blog/493541)
